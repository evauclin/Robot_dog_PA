        ...
        while True:
            ...
            for oneCmd in cmdArray:
                ...
                if data == None or data[0] == "":
                    ...
                    if (
                        self.control.move_timeout != 0
                        and self.control.relax_flag == True
                    ):
                        if self.control.move_count > 180:
                            command = (
                                ...
                                + str(180)
                                + "#"
                                + str(round(self.control.move_count - 180))
                                + "\n"
                            )
                        else:
                            if self.control.move_count == 0:
                                command = (
                                    ...
                                    + str(
                                        round(
                                            (time.time() - self.control.move_timeout)
                                            + 60
                                        )
                                    )
                                    + "\n"
                                ...
                                command = (
                                    ...
                                    + "#"
                                    + str(
                                        round(time.time() - self.control.move_timeout)
                                    )
                                    + "\n"
                                )
                    else:

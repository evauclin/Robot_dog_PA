...
class Action:
    ...
    @property
    def relax_position(self):
        return [[55, 78, 0], [55, 78, 0], [55, 78, 0], [55, 78, 0]]
    ...
    def lay(self, enter: bool = True):
        self.sit(enter=True)

    def lay2(self, enter: bool = True):
        if enter:
            xyz = self.relax_position
            for i in range(4):
                xyz[i][0] = (xyz[i][0] - self.control.point[i][0]) / 30
